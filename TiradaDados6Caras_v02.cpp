...
int sumarDadosElegidos(int vec[], int dados){
    int i, suma=0;
    for(i=0; i<dados; i++){
        if (vec[i] != 0 ){
            suma+=vec[i];
...
int contarDadosElegidos(int vec[], int dados){
    int i, cantidadDeDados=0;
    for(i=0; i<dados; i++){
        if (vec[i] != 0 ){
            cantidadDeDados++;
        }
...
int main(){
    int sumados, dadosStock, cantidadDados, puntaje;
    int vdadosStock[11]{};
    ...
    sumados = sumarDadosElegidos(vdadosElegidos,dadosStock);
    cantidadDados = contarDadosElegidos(vdadosElegidos,dadosStock);
    puntaje = sumados * cantidadDados;

    cout << endl;
    cout << "La suma de los dados elegidos es: " << sumados << endl;
    cout << endl;
    cout << "El puntaje de la ronda es: " << puntaje << endl;
    cout << endl;
    cout << "La cantidad de dados que se pasan es: " << cantidadDados << endl;
    cout << endl;
